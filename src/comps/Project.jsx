...
export default function Project({ project }){
    ...
    return (
        <div onClick={() => { window.open(project.link, "_blank") }} className={`hover:scale-105 transition-all duration-300 ease-in-out rounded shadow-xl ${ProjectThemes[conf.theme]} hover:cursor-pointer hover:opacity-75`}>
