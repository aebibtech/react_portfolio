...
export default function LoadingSpinner({ loading }){
    ...
    return (
        <div className={`h-screen w-screen ${ loading ? "visible" : "hidden" } ${themes[conf.theme]} fixed left-0 flex justify-center items-center overflow-y-auto z-50`} role="status">
